...
from Funcs.img_preprocessing import redink_remover
# sys.path.append(os.path.dirname(os.path.abspath(__file__)))
from Funcs.bulkrecfuncs.modelfunc import DET_MODEL_DIR,REC_MODEL_DIR,CLS_MODEL_DIR,SER_CLASS_DIR,KIE_MODEL_DIR,CLASS_FILE
...
# my_arg = argparse.Namespace(use_gpu=True, use_xpu=False, use_npu=False, ir_optim=True, use_tensorrt=False, min_subgraph_size=15, precision='fp32', gpu_mem=500, gpu_id=0, image_dir='', page_num=0, det_algorithm='DB', det_model_dir='TemplateOCR/Funcs/inferenced_models/det_ct.onnx', det_limit_side_len=960, det_limit_type='max', det_box_type='quad', det_db_thresh=0.3, det_db_box_thresh=0.6, det_db_unclip_ratio=0.5, max_batch_size=10, use_dilation=False, det_db_score_mode='fast', det_east_score_thresh=0.8, det_east_cover_thresh=0.1, det_east_nms_thresh=0.2, det_sast_score_thresh=0.5, det_sast_nms_thresh=0.2, det_pse_thresh=0, det_pse_box_thresh=0.85, det_pse_min_area=16, det_pse_scale=1, scales=[8, 16, 32], alpha=1.0, beta=1.0, fourier_degree=5, rec_algorithm='', rec_model_dir='TemplateOCR/Funcs/inferenced_models/rec_v4.onnx', rec_image_inverse=True, rec_image_shape='3, 48, 320', rec_batch_num=6, max_text_length=25, rec_char_dict_path=path1+'\\PaddleOCRrelease\\PaddleOCRrelease\\ppocr\\utils\\ppocr_keys_v1.txt', use_space_char=True, vis_font_path='./doc/fonts/simfang.ttf', drop_score=0.5, e2e_algorithm='PGNet', e2e_model_dir=None, e2e_limit_side_len=768, e2e_limit_type='max', e2e_pgnet_score_thresh=0.5, e2e_char_dict_path='./ppocr/utils/ic15_dict.txt', e2e_pgnet_valid_set='totaltext', e2e_pgnet_mode='fast', use_angle_cls=False, cls_model_dir='TemplateOCR/Funcs/inferenced_models/cls.onnx', cls_image_shape='3, 48, 192', label_list=['0', '180'], cls_batch_num=6, cls_thresh=0.9, enable_mkldnn=False, cpu_threads=10, use_pdserving=False, warmup=False, sr_model_dir=None, sr_image_shape='3, 32, 128', sr_batch_num=1, draw_img_save_dir='./inference_results', save_crop_res=False, crop_res_save_dir='./output', use_mp=False, total_process_num=1, process_id=0, benchmark=False, save_log_path='./log_output/', show_log=True, use_onnx=True)
my_arg = argparse.Namespace(use_gpu=True,  use_xpu=False, use_npu=False, ir_optim=True, use_tensorrt=False, min_subgraph_size=15, precision='fp32', gpu_mem=500, gpu_id=0, image_dir='', page_num=0, det_algorithm='CT', det_model_dir=DET_MODEL_DIR, det_limit_side_len=960, det_limit_type='max', det_box_type='quad', det_db_thresh=0.3, det_db_box_thresh=0.6, det_db_unclip_ratio=1.5, max_batch_size=10, use_dilation=False, det_db_score_mode='fast', det_east_score_thresh=0.8, det_east_cover_thresh=0.1, det_east_nms_thresh=0.2, det_sast_score_thresh=0.5, det_sast_nms_thresh=0.2, det_pse_thresh=0, det_pse_box_thresh=0.85, det_pse_min_area=16, det_pse_scale=1, scales=[8, 16, 32], alpha=1.0, beta=1.0, fourier_degree=5, rec_algorithm='SVTR_LCNet', rec_model_dir=REC_MODEL_DIR, rec_image_inverse=True, rec_image_shape='3, 48, 320', rec_batch_num=6, max_text_length=25, rec_char_dict_path='/data/tensorflow/kath/OCR/PaddleOCR-release-2.7/ppocr/utils/ppocr_keys_v1.txt', use_space_char=True, vis_font_path='./doc/fonts/simfang.ttf', drop_score=0.5, e2e_algorithm='PGNet', e2e_model_dir=None, e2e_limit_side_len=768, e2e_limit_type='max', e2e_pgnet_score_thresh=0.5, e2e_char_dict_path='./ppocr/utils/ic15_dict.txt', e2e_pgnet_valid_set='totaltext', e2e_pgnet_mode='fast', use_angle_cls=False, cls_model_dir=CLS_MODEL_DIR, cls_image_shape='3, 48, 192', label_list=['0', '180'], cls_batch_num=6, cls_thresh=0.9, enable_mkldnn=False, cpu_threads=10, use_pdserving=False, warmup=False, sr_model_dir=None, sr_image_shape='3, 32, 128', sr_batch_num=1, draw_img_save_dir='./inference_results', save_crop_res=False, crop_res_save_dir='./output', use_mp=False, total_process_num=1, process_id=0, benchmark=False, save_log_path='./log_output/', show_log=True, use_onnx=False)


# my_arg = argparse.Namespace(use_gpu=True, use_xpu=False, use_npu=False, ir_optim=True, use_tensorrt=False, min_subgraph_size=15, precision='fp32', gpu_mem=500, gpu_id=0, image_dir='', page_num=0, det_algorithm='DB', det_model_dir='TemplateOCR/Funcs/inferenced_models/----det_ct.onnx', det_limit_side_len=960, det_limit_type='max', det_box_type='quad', det_db_thresh=0.3, det_db_box_thresh=0.6, det_db_unclip_ratio=0.5, max_batch_size=10, use_dilation=False, det_db_score_mode='fast', det_east_score_thresh=0.8, det_east_cover_thresh=0.1, det_east_nms_thresh=0.2, det_sast_score_thresh=0.5, det_sast_nms_thresh=0.2, det_pse_thresh=0, det_pse_box_thresh=0.85, det_pse_min_area=16, det_pse_scale=1, scales=[8, 16, 32], alpha=1.0, beta=1.0, fourier_degree=5, rec_algorithm='', rec_model_dir='TemplateOCR/Funcs/inferenced_models/rec_v4.onnx', rec_image_inverse=True, rec_image_shape='3, 48, 320', rec_batch_num=6, max_text_length=25, rec_char_dict_path=path1+'\\PaddleOCRrelease\\PaddleOCRrelease\\ppocr\\utils\\ppocr_keys_v1.txt', use_space_char=True, vis_font_path='./doc/fonts/simfang.ttf', drop_score=0.5, e2e_algorithm='PGNet', e2e_model_dir=None, e2e_limit_side_len=768, e2e_limit_type='max', e2e_pgnet_score_thresh=0.5, e2e_char_dict_path='./ppocr/utils/ic15_dict.txt', e2e_pgnet_valid_set='totaltext', e2e_pgnet_mode='fast', use_angle_cls=False, cls_model_dir='TemplateOCR/Funcs/inferenced_models/cls.onnx', cls_image_shape='3, 48, 192', label_list=['0', '180'], cls_batch_num=6, cls_thresh=0.9, enable_mkldnn=False, cpu_threads=10, use_pdserving=False, warmup=False, sr_model_dir=None, sr_image_shape='3, 32, 128', sr_batch_num=1, draw_img_save_dir='./inference_results', save_crop_res=False, crop_res_save_dir='./output', use_mp=False, total_process_num=1, process_id=0, benchmark=False, save_log_path='./log_output/', show_log=True, use_onnx=True)

kie_arg=argparse.Namespace(alpha=1.0, alphacolor=(255, 255, 255), benchmark=False, beta=1.0, binarize=False, cls_batch_num=6, cls_image_shape='3, 48, 192', cls_model_dir=CLS_MODEL_DIR, cls_thresh=0.9, cpu_threads=10, crop_res_save_dir='./output', det_algorithm='DB', det_box_type='quad', det_db_box_thresh=0.6, det_db_score_mode='fast', det_db_thresh=0.3, det_db_unclip_ratio=1.5, det_east_cover_thresh=0.1, det_east_nms_thresh=0.2, det_east_score_thresh=0.8, det_limit_side_len=960, det_limit_type='max', det_model_dir='/data/kath/models/ch_PP-OCRv4_det_infer', det_pse_box_thresh=0.85, det_pse_min_area=16, det_pse_scale=1, det_pse_thresh=0, det_sast_nms_thresh=0.2, det_sast_score_thresh=0.5, draw_img_save_dir='./inference_results', drop_score=0.5, e2e_algorithm='PGNet', e2e_char_dict_path='./ppocr/utils/ic15_dict.txt', e2e_limit_side_len=768, e2e_limit_type='max', e2e_model_dir=None, e2e_pgnet_mode='fast', e2e_pgnet_score_thresh=0.5, e2e_pgnet_valid_set='totaltext', enable_mkldnn=False, fourier_degree=5, gpu_id=0, gpu_mem=500, image_dir='/data/kath/sources/examples', image_orientation=False, invert=False, ir_optim=True, kie_algorithm='LayoutXLM', label_list=['0', '180'], layout=True, layout_dict_path='../ppocr/utils/dict/layout_dict/layout_publaynet_dict.txt', layout_model_dir=None, layout_nms_threshold=0.5, layout_score_threshold=0.5, max_batch_size=10, max_text_length=25, merge_no_span_structure=True, min_subgraph_size=15, mode='structure', ocr=True, ocr_order_method='tb-yx', output='./output', page_num=0, precision='fp32', process_id=0, re_model_dir=None, rec_algorithm='SVTR_LCNet', rec_batch_num=6, rec_char_dict_path='/data/tensorflow/kath/OCR/PaddleOCR-release-2.7/ppocr/utils/ppocr_keys_v1.txt', rec_image_inverse=True, rec_image_shape='3, 48, 320', rec_model_dir='/data/kath/models/ch_PP-OCRv4_rec_infer', recovery=False, save_crop_res=False, save_log_path='./log_output/', scales=[8, 16, 32], ser_dict_path='/data/kath/data/Datasets/allLabel.txt', ser_model_dir='../inferencedModel/ser_vi_layout_infer', show_log=True, sr_batch_num=1, sr_image_shape='3, 32, 128', sr_model_dir=None, table=True, table_algorithm='TableAttn', table_char_dict_path='../ppocr/utils/dict/table_structure_dict_ch.txt', table_max_len=488, table_model_dir=None, total_process_num=1, use_angle_cls=False, use_dilation=False, use_gpu=True, use_mp=False, use_npu=False, use_onnx=False, use_pdf2docx_api=False, use_pdserving=False, use_space_char=True, use_tensorrt=False, use_visual_backbone=True, use_xpu=False, vis_font_path='../doc/fonts/simfang.ttf', warmup=False)


def text_pred_res_det(img,image_file,savename, model):#kie_model_dir,
    ...
    args.rec_char_dict_path='/data/tensorflow/kath/OCR/PaddleOCR-release-2.7/ppocr/utils/ppocr_keys_v1.txt'
    ...
    t01=time.time()
    print('loading model time:',t01-t0)
    is_visualize = True
    ...
    SERCONF={'Global':
                 {'use_gpu': False, 'epoch_num': 200, 'log_smooth_window': 10, 'print_batch_step': 10, 
                  ...
                  'seed': 2022, 'infer_img': '',
                  'save_res_path': './', 'kie_rec_model_dir':REC_MODEL_DIR,
             ...
             'PostProcess': {'name': 'VQASerTokenLayoutLMPostProcess', 'class_path': CLASS_FILE},
             ...
             'Train': {'dataset': {'name': 'SimpleDataSet', 'data_dir': '', 'label_file_list': [''], 'ratio_list': [1.0],
                                   'transforms': [{'DecodeImage': {'img_mode': 'RGB', 'channel_first': False}}, {'VQATokenLabelEncode': {'contains_re': False, 'algorithm': 'LayoutXLM', 'class_path': CLASS_FILE, 'use_textline_bbox_info': True, 'order_method': 'tb-yx'}}, {'VQATokenPad': {'max_seq_len': 512, 'return_attention_mask': True}}, {'VQASerTokenChunk': {'max_seq_len': 512}}, {'Resize': {'size': [224, 224]}}, {'NormalizeImage': {'scale': 1, 'mean': [123.675, 116.28, 103.53], 'std': [58.395, 57.12, 57.375], 'order': 'hwc'}}, {'ToCHWImage': None}, {'KeepKeys': {'keep_keys': ['input_ids', 'bbox', 'attention_mask', 'token_type_ids', 'image', 'labels']}}]},
                       'loader': {'shuffle': True, 'drop_last': False, 'batch_size_per_card': 16, 'num_workers': 0}}, 'Eval': {'dataset': {'name': 'SimpleDataSet', 'data_dir': '/data/kath/data/Datasets/', 'label_file_list': ['/data/kath/data/Datasets/val.txt'], 'transforms': [{'DecodeImage': {'img_mode': 'RGB', 'channel_first': False}}, {'VQATokenLabelEncode': {'contains_re': False, 'algorithm': 'LayoutXLM', 'class_path':CLASS_FILE, 'use_textline_bbox_info': True, 'order_method': 'tb-yx'}}, {'VQATokenPad': {'max_seq_len': 512, 'return_attention_mask': True}}, {'VQASerTokenChunk': {'max_seq_len': 512}}, {'Resize': {'size': [224, 224]}},
    ...
    #               'kie_det_model_dir': path1+'\\inferenced_models\\det2', 'infer_mode': False,
    #               'det_algorithm': 'SAST', 'det_model_dir': path1+'\\inferenced_models\\det2',
    ...
    t0=time.time()
    ser_engine = model#SerPredictor(SERCONF)

    t01=time.time()
    print('ser model loading time:', t01-t0)
...
#
#         save_img_path = os.path.join(
#             INFERED_CONF['Global']['save_res_path'],
#             os.path.splitext(os.path.basename(img_path))[0] + "_ser.jpg")
#         t2=time.time()
#         result, _ = ser_engine(data)
#         result = result[0]
...
def text_pred_res_bulk(image_file,ser_engine):
    t1=time.time()
    INFERED_CONF['Global']['infer_img']=image_file
    INFERED_CONF['Architecture']['Backbone']['checkpoints'] = path1+r'/inferenced_models/ser/inference'
    INFERED_CONF['Global']['use_gpu'] = False
    ...
    os.makedirs(INFERED_CONF['Global']['save_res_path'], exist_ok=True)
    INFERED_CONF['Global']['det_model_dir']= path1+r"\\inferenced_models\\det2"
    INFERED_CONF['Global']['kie_det_model_dir']=path1+r"\\Funcs\\inferenced_models\\det2"
    ...
    return res,infer_imgs
# SERCONF={'Global':
#                  {'use_gpu': False, 'epoch_num': 200, 'log_smooth_window': 10, 'print_batch_step': 10,
#                   'save_model_dir': './output/BigModel1', 'save_epoch_step': 2000, 'eval_batch_step': [0, 59],
#                   'cal_metric_during_train': False, 'save_inference_dir': None, 'use_visualdl': False,
#                   'seed': 2022, 'infer_img': path1+"/outputs//"+'111'+'.txt',
#                   'save_res_path': path1+"\\outputs\\serRes", 'kie_rec_model_dir':path1+ '\\inferenced_models\\ch_PP-OCRv4_rec_infer',
...
#                                    'transforms': [{'DecodeImage': {'img_mode': 'RGB', 'channel_first': False}}, {'VQATokenLabelEncode': {'contains_re': False, 'algorithm': 'LayoutXLM', 'class_path': path1+'\\inferenced_models\\ser\\allLabel.txt', 'use_textline_bbox_info': True, 'order_method': 'tb-yx'}}, {'VQATokenPad': {'max_seq_len': 512, 'return_attention_mask': True}}, {'VQASerTokenChunk': {'max_seq_len': 512}}, {'Resize': {'size': [224, 224]}}, {'NormalizeImage': {'scale': 1, 'mean': [123.675, 116.28, 103.53], 'std': [58.395, 57.12, 57.375], 'order': 'hwc'}}, {'ToCHWImage': None}, {'KeepKeys': {'keep_keys': ['input_ids', 'bbox', 'attention_mask', 'token_type_ids', 'image', 'labels']}}]},
#                        'loader': {'shuffle': True, 'drop_last': False, 'batch_size_per_card': 16, 'num_workers': 0}}, 'Eval': {'dataset': {'name': 'SimpleDataSet', 'data_dir': '/data/kath/data/Datasets/', 'label_file_list': ['/data/kath/data/Datasets/val.txt'], 'transforms': [{'DecodeImage': {'img_mode': 'RGB', 'channel_first': False}}, {'VQATokenLabelEncode': {'contains_re': False, 'algorithm': 'LayoutXLM', 'class_path': path1+'\\inferenced_models\\ser\\SWallLabel.txt', 'use_textline_bbox_info': True, 'order_method': 'tb-yx'}}, {'VQATokenPad': {'max_seq_len': 512, 'return_attention_mask': True}}, {'VQASerTokenChunk': {'max_seq_len': 512}}, {'Resize': {'size': [224, 224]}},
#                                     {'NormalizeImage': {'scale': 0.8, 'mean': [123.675, 116.28, 103.53], 'std': [58.395, 57.12, 57.375], 'order': 'hwc'}}, {'ToCHWImage': None}, {'KeepKeys': {'keep_keys': ['input_ids', 'bbox', 'attention_mask', 'token_type_ids', 'image', 'labels']}}]},'loader': {'shuffle': False, 'drop_last': False, 'batch_size_per_card': 16, 'num_workers': 0}}, 'profiler_options': None}
...
def text_pred_res_bulk2(image_file, ser_engine):
    args = my_arg
    t1=time.time()
    print('========================')
    args.use_gpu=False
    ...
    starttime=time.time()
    print('------------')
    img = [cv2.imread(path) for path in image_file_list]
    total_res = []
    for sub_img in img:
        sub_img_=redink_remover(sub_img)
        dt_boxes, rec_res, time_dict = text_sys(sub_img_)
    ...
    infer_imgs=''
    ser_res = []
    for idx, info in enumerate(image_file_list):
        img_path = info
        data = {'img_path': img_path, 'label': json.dumps(total_res[idx], ensure_ascii=False)}
        result, _ = ser_engine(data)

        result = result[0]
        ser_res.append(result)
    ...
    return ser_res,image_file_list


if __name__ == '__main__':
    print()
    # text_pred_res(img, r'D:\\trans_work_jian\\suibian\\temp\\1.jpg')
    # img = cv2.imread(r"C:\Users\181082\Desktop\2.jpg")
    # SerPredictor = SerPredictor_Model()
    # text_pred_res_det(img, r"C:\Users\181082\Desktop\2.jpg", '111', SerPredictor)
    # text_pred_res_bulk(r'D:\trans_work_jian\suibian\OCRProject\OCRProject\backend\static\media\template_file\bulk_img')